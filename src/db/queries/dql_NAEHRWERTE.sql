...
SELECT
    b.BESTELLNR,
    zn.FETT_G * (rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE) AS FETT_G,
    zn.ZUCKER_G * (rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE) AS ZUCKER_G,
    zn.KOHLENHYDRATE_G * (rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE) AS KOHLENHYDRATE_G,
    zn.PROTEIN_G * (rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE) AS PROTEIN_G,
    zn.KALORIEN_KCAL * (rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE) AS KALORIEN_KCAL,
    zn.NATRIUM_G * (rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE) AS NATRIUM_G,
    zn.GESAETTIGTE_FETTSAUREN_G * (rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE) AS GESAETTIGTE_FETTSAUREN_G,
    zn.BALLASTSTOFFE_G * (rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE) AS BALLASTSTOFFE_G,
    rz.REZEPT_ZUTATENMENGE * br.REZEPTMENGE AS MENGE
FROM BESTELLUNG b
