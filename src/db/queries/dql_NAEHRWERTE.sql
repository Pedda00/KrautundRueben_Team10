...
zn.BALLASTSTOFFE_G * bz.ZUTATENMENGE AS BALLASTSTOFFE_G,
...
zn.NATRIUM_G * (rz.ZUTATENMENGE * br.ZUTATENMENGE) AS NATRIUM_G,
zn.GESAETTIGTE_FETTSAUREN_G * (rz.ZUTATENMENGE * br.ZUTATENMENGE) AS GESAETTIGTE_FETTSAUREN_G,
zn.BALLASTSTOFFE_G * (rz.ZUTATENMENGE * br.ZUTATENMENGE) AS BALLASTSTOFFE_G
